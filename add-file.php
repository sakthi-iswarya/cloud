  ...
  $allowTypes = array('jpg','png','jpeg','gif','pdf');
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
          $msg=mysqli_query($con,"insert into files(file_name,file_id,image) values('$name','$fid','".$fileName."')");
        }
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Add File </h3>
        <div class="row">
                  ...
                  <div class="col-md-8">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              ...
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Secure Id</label>
                              <div class="col-sm-10">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">File</label>
                              <div class="col-sm-10">
                          ...
                          <input type="submit" name="Submit" value="Add File" class="btn btn-theme"></div>
                          </form>
                      </div>
                  </div>
              </div>
